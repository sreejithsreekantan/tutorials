...
void Data::SerializeWithCachedSizes(
  ...
  // optional sint32 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt32(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional sint32 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt32ToArray(1, this->i(), target);
  }
