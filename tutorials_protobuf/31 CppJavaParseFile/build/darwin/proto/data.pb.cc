...
void protobuf_AssignDesc_data_2eproto() {
  ...
  static const int Data_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Data, f_),
  };
  Data_reflection_ =
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional float f = 1;
  if (has_f()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(1, this->f(), target);
  }
