...
void protobuf_AssignDesc_data_2eproto() {
  ...
  static const int Data_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Data, m_),
  };
  Data_reflection_ =
...
void protobuf_AddDesc_data_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\ndata.proto\"C\n\004Data\022\031\n\001m\030\001 \001(\0132\016.Data.M"
...
void Data::InitAsDefaultInstance() {
  m_ = const_cast< ::Data_MiniData*>(&::Data_MiniData::default_instance());
}
...
void Data::MergeFrom(const Data& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_m()) {
      mutable_m()->::Data_MiniData::MergeFrom(from.m());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
