...
void Data::SerializeWithCachedSizes(
  ...
  // optional sfixed32 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteSFixed32(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional sfixed32 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSFixed32ToArray(1, this->i(), target);
  }
