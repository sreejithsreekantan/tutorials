...
void protobuf_AssignDesc_data_2eproto() {
  ...
  static const int Data_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Data, i_),
  };
  Data_reflection_ =
...
void protobuf_AddDesc_data_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\ndata.proto\"\030\n\004Data\022\020\n\001i\030\001 \001(\001:\0053.414", 38);
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional double i = 1 [default = 3.414];
      case 1: {
...
void Data::SerializeWithCachedSizes(
  ...
  // optional double i = 1 [default = 3.414];
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteDouble(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional double i = 1 [default = 3.414];
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteDoubleToArray(1, this->i(), target);
  }
