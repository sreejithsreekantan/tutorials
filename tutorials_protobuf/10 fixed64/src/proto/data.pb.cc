...
void Data::SerializeWithCachedSizes(
  ...
  // optional fixed64 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed64(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional fixed64 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed64ToArray(1, this->i(), target);
  }
