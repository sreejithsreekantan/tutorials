...
class Sree : public ::google::protobuf::Message {
 public:
  Sree();
  virtual ~Sree();

  Sree(const Sree& from);

  inline Sree& operator=(const Sree& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Sree& default_instance();

  void Swap(Sree* other);
  ...
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Sree& from);
  void MergeFrom(const Sree& from);
  void Clear();
  bool IsInitialized() const;
  ...
  static ::google::protobuf::internal::ExtensionIdentifier< ::Data,
      ::google::protobuf::internal::PrimitiveTypeTraits< ::google::protobuf::int32 >, 5, false >
    bar;
  // @@protoc_insertion_point(class_scope:Sree)
 private:
