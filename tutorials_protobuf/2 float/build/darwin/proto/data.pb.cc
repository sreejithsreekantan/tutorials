...
void Data::SerializeWithCachedSizes(
  ...
  // optional float i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional float i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(1, this->i(), target);
  }
