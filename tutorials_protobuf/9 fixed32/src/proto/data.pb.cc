...
void Data::SerializeWithCachedSizes(
  ...
  // optional fixed32 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteFixed32(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional fixed32 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFixed32ToArray(1, this->i(), target);
  }
