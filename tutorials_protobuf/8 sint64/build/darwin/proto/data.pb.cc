...
void Data::SerializeWithCachedSizes(
  ...
  // optional sint64 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteSInt64(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional sint64 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSInt64ToArray(1, this->i(), target);
  }
