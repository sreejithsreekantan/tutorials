...
void Data::SerializeWithCachedSizes(
  ...
  // optional bool i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional bool i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(1, this->i(), target);
  }
