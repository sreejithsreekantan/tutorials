...
void Data::SerializeWithCachedSizes(
  ...
  // optional sfixed64 i = 1;
  if (has_i()) {
    ::google::protobuf::internal::WireFormatLite::WriteSFixed64(1, this->i(), output);
  }
...
::google::protobuf::uint8* Data::SerializeWithCachedSizesToArray(
  ...
  // optional sfixed64 i = 1;
  if (has_i()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteSFixed64ToArray(1, this->i(), target);
  }
